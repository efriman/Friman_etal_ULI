...
GSE24029_RAD21_mESC_remap.bed
GSE41314_RNF2_mESC_remap.bed
...
--outname $outputdir/$coolpup'_'$peak'_subset5000_expected_cisbalanced.clpy' --n_proc 4 \
--clr_weight_name "cis_weight" --subset 5000 --seed 1
